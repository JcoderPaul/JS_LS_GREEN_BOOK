...
function pushIfUnique(searchableArray, numberForFind){
        if(!searchableArray.includes(numberForFind)){
                searchableArray.push(numberForFind);
        } else {
                console.log(`${numberForFind} уже в массиве`);
        }
}
