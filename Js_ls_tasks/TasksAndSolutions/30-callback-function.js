...
setTimeout(function myFn() { // Функция объявлена "внутри" и не видна "снаружи"
  console.log('Привет из функции myFn')
}, 2000)

myFn() // <-- ReferenceError: myFn is not defined

/* Закомментировать вызов, или удалить, или переопределить функцию раньше вызова с задержкой */
